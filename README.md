...
![LOC](https://sonarcloud.io/api/project_badges/measure?project=crossecore_ecore-csharp&metric=ncloc)
![Maintainability](https://sonarcloud.io/api/project_badges/measure?project=crossecore_ecore-csharp&metric=sqale_rating)
![Security](https://sonarcloud.io/api/project_badges/measure?project=crossecore_ecore-csharp&metric=security_rating)
![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=crossecore_ecore-csharp&metric=vulnerabilities)
